...
function generateDateFormats(date){
  ...
  function getNextPalindromeDate(date) {
    ...
    while (1) {
      ctr++;
      var dateStr = convertToString(nextDate);
      var resultList = checkPalindromeAllFormats(dateStr);
  ...
  function getPreviousPalindromeDate(date) {
    ...
    while (1) {
      ctr++;
      var dateStr = convertToString(previousDate);
      var resultList = checkPalindromeAllFormats(dateStr);
  ...
  function clickHandler(e) {
    ...
    if (bdayString !== '') {
      ...
      var list = checkPalindromeAllFormats(dateStr);
